<script lang="ts">
    ...
    let showRepairOpts = false;
    let showProgress = false;
    let progressContainer: HTMLDivElement;
    let progressBar: HTMLDivElement;
    // const statusDiv = document.getElementById("status");
    let repairOptions: string[] = ['fix-normals', 'remove-duplicates', 'fill-holes'];
    ...
    function computeNormals(geometry) {
        ...
        // TODO: Fix inverted normals based on coherence for more advanced normal fixing
...
<div class="container">
    <a href="https://github.com/ianfabs/stlfixer" target="_blank" rel="noopener noreferrer" class="github-link" aria-label="Link to GitHub for STL Fixer">
    ...
    <div class="repair-options" id="repair-options">
        ...
        <input type="checkbox" value="fix-normals" bind:group={repairOptions}/>
        <label for="fix-normals">Fix Inverted Normals</label>
        <input type="checkbox" value="remove-duplicates" bind:group={repairOptions}/>
        <label for="remove-duplicates">Remove Duplicate Vertices</label>
        <input type="checkbox" value="fill-holes" bind:group={repairOptions}/>
    ...
    <footer>
        <p class="copyright">© 2025 STL Repair Tool. Made with 🔧 by <a href="https://github.com/ianfabs">Ian Fabs</a>.</p>
    </footer>
</div>
